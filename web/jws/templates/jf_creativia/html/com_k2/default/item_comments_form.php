...
<table width="100%" cellpadding="0" cellspacing="0">
	...
	<label class="formName" for="userName"><?php echo JText::_('K2_NAME'); ?> (required)</label>
	...
	<label class="formEmail" for="commentEmail"><?php echo JText::_('K2_EMAIL'); ?> (required)</label>
	...
	<label class="formComment" for="commentText"><?php echo JText::_('K2_MESSAGE'); ?> (required)</label>
	<textarea rows="20" cols="8" class="inputbox" onblur="if(this.value=='') this.value='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>';" onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>') this.value='';" name="commentText" id="commentText"><?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?></textarea>
